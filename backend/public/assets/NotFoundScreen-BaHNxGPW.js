import{j as e}from"./vendor-animation-BPU33bTl.js";import"./vendor-utils-CDF-lQ4x.js";import{u as l,g as n}from"./index-Cg489I53.js";import{B as s,T as c}from"./index-DTIAOzgS.js";import"./vendor-icons-C3sZCBx4.js";const m=()=>(l(()=>{const t=a=>{const i=(a.clientX/window.innerWidth-.5)*20,r=(a.clientY/window.innerHeight-.5)*20;n.to(".content-404",{x:i,y:r,duration:1,ease:"power2.out"}),n.to(".light-leak",{x:-i*1.5,y:-r*1.5,duration:1.5,ease:"power2.out"})};return window.addEventListener("mousemove",t),()=>window.removeEventListener("mousemove",t)}),e.jsxs("div",{className:"relative min-h-screen bg-zinc-950 text-zinc-50 flex flex-col items-center justify-center overflow-hidden font-sans",children:[e.jsx("div",{className:"light-leak absolute w-[150vw] h-[150vh] pointer-events-none z-0",style:{background:`radial-gradient(circle at 50% 50%, rgba(139, 92, 246, 0.15), transparent 60%),
