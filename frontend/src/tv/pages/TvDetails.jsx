...
import { Play, Star, Calendar, Heart, Bookmark, List, Tv, Clock, Volume2, VolumeX } from 'lucide-react';
...
const TvDetails = () => {
      ...
      if (isInternal) {
        ...
        setShow({
          ...
          videos: localShow.trailerUrl ? {
            results: [{
              key: extractYouTubeId(localShow.trailerUrl),
              site: 'YouTube',
              type: 'Trailer'
            }]
          } : { results: [] }
  ...
  const ambientColor = getAmbientGlowColor(show.genres || show.genre);
